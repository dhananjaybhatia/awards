      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
            ...
            description={
              "A cross-platform metagame app, turning your activies across Web2 and Web3 games into a rewarding adventure."
            }
            isComingSoon={"true"}
          />
        </BentoTilt>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7 ">
          ...
          <BentoTilt className="bento-tilt_1 border-hsla row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description={
                "A gamified social hub, adding a new dimension of play to social interation for Web3 communities."
              }
            />
          </BentoTilt>
